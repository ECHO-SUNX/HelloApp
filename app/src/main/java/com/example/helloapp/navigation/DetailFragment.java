...
import com.example.helloapp.databinding.FragmentDetail2Binding;
...
public class DetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentDetail2Binding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_detail2, container, false);
        ...
        binding.button8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                navController.navigate(R.id.action_detailFragment2_to_homeFragment2);
            }
        });
